...
### 1) 모든 실습은 '혼자서도 끝까지' 완주할 수 있게 만들었습니다
수업에서는 **개념과 흐름**을 잡고, 실습은 집에서 마저 합니다. 모든 노트북은 **정답 + 셀마다 실행 결과·해석까지 담은 완전체**라, 수업에서 다루지 못한 부분도 **혼자 처음부터 끝까지 셀프스터디로 완주**할 수 있습니다. (수업 진도에 쫓길 필요가 없습니다.)
